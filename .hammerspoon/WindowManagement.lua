...
-- hyper + h/j/k/l                                                 
hs.hotkey.bind(hyper, "h", function() -- left
  place({x = 0, y = 0, w = myGrid.left, h = myGrid.h})
end)
hs.hotkey.bind(hyper, "j",  function() -- middle
   place({x = myGrid.left, y = 0, w = myGrid.middle, h = myGrid.h})
end)
hs.hotkey.bind(hyper, "k", function() -- full screen
  place({x = 0, y = 0, w = myGrid.w, h = myGrid.h})
end) 
hs.hotkey.bind(hyper, "l", function() -- right
